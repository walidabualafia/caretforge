...
Thanks for your interest in contributing to CaretForge! Contributions of all kinds are welcome — bug reports, feature requests, documentation improvements, and code.
...
This is the most common type of contribution. See the [Adding Providers](/guide/adding-providers) guide, or follow these steps:
...
If you discover a security vulnerability, please **do not open a public issue**. Instead, email abualafia@rocketmail.com with details. See the [Security](/reference/security) docs for more.

## License

By contributing to CaretForge, you agree that your contributions will be licensed under the [MIT License](https://github.com/walidabualafia/caretforge/blob/main/LICENSE).
